...
fileprivate let input_folder = "DIT"

final class TC_DIT_Tests: XCTestCase {

    func test_TC_DIT_001() throws {
        let report = try analyze(input: "\(input_folder)/TC-DIT-001.swift")
    ...
    func test_TC_DIT_002() throws {
        let report = try analyze(input: "\(input_folder)/TC-DIT-002.swift")
    ...
    func test_TC_DIT_003() throws {
        let report = try analyze(input: "\(input_folder)/TC-DIT-003.swift")
    ...
    func test_TC_DIT_004() throws {
        let report = try analyze(input: "\(input_folder)/TC-DIT-004/")
    ...
    func test_TC_DIT_005() throws {
        let report = try analyze(input: "\(input_folder)/TC-DIT-005.swift")
